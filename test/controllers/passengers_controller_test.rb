...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { address: @passenger.address, email: @passenger.email, name: @passenger.name, passenger_id: @passenger.passenger_id, phone: @passenger.phone } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { address: @passenger.address, email: @passenger.email, name: @passenger.name, passenger_id: @passenger.passenger_id, phone: @passenger.phone } }
